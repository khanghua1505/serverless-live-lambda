module github.com/aboutkh/serverless-live-lambda/examples/go/graphql-apigw-lambda

go 1.18.0

require (
	github.com/99designs/gqlgen v0.17.40
	github.com/aboutkh/serverless-live-lambda/support/go v0.0.0-20231126153545-305e4d5db6e4
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/iot v1.45.1 // indirect
